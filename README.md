...
- **[This project contains html and css files with some content like the project name and styling.]**
- **[ This project is free of any type of errors and all the errors are corrected by linters. ]**
- **[project contains two branches. <br>i - main.<br> ii - feature-branch.<br> The main branch contains all the important files and folders of the project. The feature-branch contains the files of html and css content.]**
...
- GitHub: [@githubhandle](https://github.com/Hammadzulfiqarx)
